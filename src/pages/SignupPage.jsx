...
function SignupPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://8vsnyikz5c.execute-api.eu-north-1.amazonaws.com/API_Latest/register', formData); // replace with your  signup  api endpoint
